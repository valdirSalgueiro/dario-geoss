...
<?php
		if ($result = $db->query($query)) {
			while ($obj = $result->fetch_object()) {			
				...
				echo "<td><a href=\"cadveiculo.php?id=$veiculo->id\" class=\"glyphicon glyphicon-edit\"></a></td><td><a href=\"javascript:apagar(\"veiculo\",$veiculo->id)\" class=\"glyphicon glyphicon-remove\"></a></td></tr>";
			}
