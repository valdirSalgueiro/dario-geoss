...
if($id){
	...
	$sql = "SELECT * FROM `dia_horario_servico` WHERE idx_servico=$id";
	$res = $db->query( $sql );
...
<div class="conteudo-principal">
    <fieldset>  
					    ...
					    <div class="form-group col-md-12" style="text-align: left">
							Vagas:
							<input type="text" name="vagas" class=" form-control input-sm"  placeholder="Vagas" value="<?php echo $servico->vagas?>">								
					   </div>
