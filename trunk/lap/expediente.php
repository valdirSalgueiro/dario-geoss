              ...
              <tr>
                <td height="464" valign="top"><table width="50" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="images/bg.jpg"><span class="style26 style28">&nbsp;<span class="style31">Sobre Portal Sentinela </span></span></td>
                      </tr>
                    </table>
...
//Vendo se existe expediente cadastrado

$consulta2 = mysql_query("SELECT count(descricao) as total FROM expediente") or die(mysql_error());
$totalexp = mysql_result($consulta2,0,"total");

if($totalexp==0){ echo "<br><br><font class='materia'>Não há informação cadastrada.</font>"; } else {

echo $campo_exp[descricao];
}
                  ...
                  <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                      <td height="68" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style11 style25"><strong>&nbsp;<span class="style31">Enquete:</span></strong></div></td>
                        </tr>
                      </table>
