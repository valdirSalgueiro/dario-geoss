    ...
    <td width="474" valign="top" class="style22"><table width="470" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="622" height="575" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              <tr>
                <td height="464" valign="top"><table width="50" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <center>
<form action="http://www.portalsentinela.com/buscaportal.php" id="cse-search-box">
  <div>
    <input type="hidden" name="cx" value="partner-pub-3585189984164153:1542pd-w02j" />
    <input type="hidden" name="cof" value="FORID:11" />
    <br><br>
    Pesquisa Dentro do Portal Sentinela:<br />
    <input type="text" name="q" size="28" />
    <input type="submit" name="sa" value="Pesquisar" />
  </div>
</form>
                      ...
                      <tr>
                        <td height="20" background="images/bg.jpg"><span class="style26 style28"><span class="menu">
                          ...
                          <?php } ?>
					           ...
					           <form action="http://www.portalsentinela.com/busca.php" id="cse-search-box"><td height="20" background="images/bg.jpg"><span class="style26 style28">
<style type="text/css">
@import url(http://www.google.com/cse/api/branding.css);
</style>
        ...
        <input type="hidden" name="cof" value="FORID:11" />
        <input type="text" name="q" size="28" />
        <input type="submit" name="sa" value="Pesquisar" /></td></form>
                    </table>
                    <p><br />
                      <br />
          ...
          <td height="59" class="style22"><table width="470" height="62" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#666666">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="620" height="60" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td height="60" valign="top"><center><script type="text/javascript"><!--
google_ad_client = "pub-3585189984164153";
/* 468x60, created 5/10/08 */
google_ad_slot = "8338831964";
google_ad_width = 468;
google_ad_height = 60;
//-->
</script>
