...
$busca_foto="select * from foto_foto_dia where codigo_foto_dia = '".$codigo_foto_dia."' order by codigo_foto asc;";
...
<tr><td></td><td><input type=button class=botao value=" Adicionar Foto " onClick="window.location='cad_foto_foto_dia.php?codigo_foto_dia=<?phpecho $codigo_foto_dia;?>';"><input type=button value="FIM" class=botao onClick="window.location='conteudo.php';"></td></tr>
...

{
 ...
 $del_foto="delete from foto_foto_dia where";
...

 {
  ...
  echo "<script>window.location='mod_foto_foto_dia.php?codigo_foto_dia=$codigo_foto_dia';</script>";
