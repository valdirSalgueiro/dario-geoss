...

{
 ...
 echo "<tr><td>Link completo com http://www.site :</td><td><input type=text name='descricao_foto$x' class=botao size=50 maxlength=100><BR></td></tr>";
...

{
...

 {
...

  {
...

   {
    ...
    $cad_foto="insert into foto_propaganda values ('".$codigo_propaganda."','','".$descricao_foto."','".$dimencao."','');";
...

    {
     ...
     $mod_foto="update foto_propaganda set foto = '".$dir.mysql_insert_id().$ext."' where codigo_foto = '".mysql_insert_id()."';";
...

 {
  ...
  window.location='cad_foto_propaganda.php?codigo_propaganda=$codigo_propaganda';</script>";
