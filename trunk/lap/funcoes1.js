...
function Comentar(id) {
	window.open('comentarios.php?id='+id+'','comentarios','width=400,height=500,status=no,menubar=no,scrollbars=yes,toolbar=no,resizable=no')
	document.form_login.target = 'comentarios'
	document.form_login.action = 'comentarios.php?id='+id+''
	document.form_login.submit();
}
