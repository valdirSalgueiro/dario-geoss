...
.style33 {font-size:11px; font-family: Tahoma;}
</style>
              ...
              <tr>
                <td height="2"><table width="772" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="42%" class="style11 style1 style25"><span class="style25"><a href="videos.php">Videos</a> | <a href="#">Sobre</a> | <a href="#">Equipe</a> | <a href="contato.php">Fale Conosco</a> | <a href="lap_adm" onclick="javascript:window.external.AddFavorite('http://www.portalsentinela.com/','Portal Sentinela');">Admin</a></span></td>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <?
						...
						$codigo_noticia=$_GET['codigo_noticia'];
						 ...
						 $busca_mate="SELECT * FROM noticias WHERE codigo_noticia = '".$codigo_noticia."' ORDER BY codigo_noticia DESC;";
$res_busca_mate=mysql_query($busca_mate,$conn);
$campo_mate=mysql_fetch_array($res_busca_mate);
$soma = $campo_mate['visualizacoes']+1;
if(!$_POST['voltar']){
$up2 = mysql_query("UPDATE noticias SET  visualizacoes='".$soma."' WHERE codigo_noticia = '".$codigo_noticia."' ") or die(mysql_error());
}
...
$consulta_cod = mysql_query("SELECT count(codigo_noticia) as total FROM noticias WHERE codigo_noticia = '".$_GET['codigo_noticia']."'") or die(mysql_error());
$total_cod = mysql_result($consulta_cod,0,"total");

if($total_cod==0){  echo "<script>alert('Código Inexistente');
 ...
 top.location='index.php';</script>"; }  
			...
			while($materias=mysql_fetch_array($consultass)) {
			 ...
			 $busca_foto="select * from foto_noticias where codigo_noticia = '".$materias[codigo_noticia]."' order by rand();";
             $res_busca_foto=mysql_query($busca_foto,$conn);
             $num_foto=mysql_num_rows($res_busca_foto);
                  ...
                  <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                      <td height="68" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style11 style25"><strong>&nbsp;<span class="style32">Enquete:</span></strong></div></td>
                        </tr>
                      </table>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td height="68" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style11 style25"><strong>&nbsp;<span class="style32">Foto do Dia :</span></strong></div></td>
                          </tr>
                        </table>
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                    ...
                    <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td height="68"><div align="center" class="style21">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style25 style25"><strong>&nbsp;<span class="style32">Publicidade:</span></strong></div></td>
                              </tr>
                            </table>
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
