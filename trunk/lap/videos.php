...
*/
    ...
    <td width="474" valign="top" class="style22"><table width="470" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
      <tr>
              ...
              <tr>
                <td height="464" valign="top"><table width="50" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="images/bg.jpg"><span class="style26 style28">&nbsp;<span class="style31">V&iacute;deos</span></span></td>
                      </tr>
                    </table>
        ...
        include "conn.php";
		include "data.php";
		if(($codigo_video==NULL)and($_GET[busca]==NULL))

		{

         echo "<br><form name=form1 method=post>

		 <input type=checkbox onclick='visivel(this,document.all.busca_video);'> Procurar Video.

		 <div id='busca_video' style='display:none'>

		 <table border=0 class=fonte>

		 <tr><td>T&iacute;tulo do Video:</td><td><input type=text name=busca class=botao size=20></td><td><input type=submit value=' Procurar ' class=botao></td></tr>
		...
		?>
		   ...
		   $mod_video = "update videos set visualizacoes = visualizacoes + 1 WHERE codigo_video = $codigo_video;";
...

    {
...

     {
      ...
      $busca_video="select * from videos WHERE ativado = '0' order by codigo_video desc;";
...

     {
      ...
      $busca_video="select * from videos WHERE nome_video like '%".$busca."%' AND ativado = '0' order by codigo_video desc;";
...

     {
...

      {
       ...
       if($campo_video[codigo_video]!=NULL)

       {

           
        echo "<tr><td width='20'>$imagem_video</td><td><font color=black><b><a href='ver_video.php?codigo_video=$campo_video[codigo_video]'><font class=materia><b>$campo_video[nome_video]</b></a></b><BR>$campo_video[desc_video]<br>$campo_video[data_cadastro] - $campo_video[hora_cadastro] <BR>

		

		Visualiza&ccedil;oes : <b>$campo_video[visualizacoes]</b></font>
...

    {
     ...
     $busca_video="select * from videos  where codigo_video = '".$codigo_video."' AND ativado = '0';";
