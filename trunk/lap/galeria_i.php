...
*/
              ...
              <tr>
                <td height="464" valign="top"><table width="50" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="images/bg.jpg"><span class="style26 style28 style30"><span class="style25">&nbsp;Galeria de Fotos do Internauta </span></span></td>
                      </tr>
                      <tr>
                        <td height="20"><a href="admin/cad_galeria_i.php" class="fonte_link"><strong>Clique Aqui para Cadastrar uma galeria </strong></a></td>
                      </tr>
                    </table>
...

    {
...

     {
      ...
      $busca_galeria="select * from galerias WHERE tipo='i'  order by nome_galeria asc;";
...

     {
      ...
      $busca_galeria="select * from galerias where nome_galeria like '%".$busca."%' AND tipo='i'  order by nome_galeria asc;";
...
<td><center><a href='#' title='Veja o Album da Galeria $campo_galeria[nome_galeria] ' onclick=window.open('album_galerias.php?codigo_galeria=$campo_galeria[codigo_galeria]','Entrada','toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=no,scrollbars=no,width=850,height=650');><img src=admin/$campo_foto[foto] name=PictureBox width=80 border=0><BR> ";
...

    {
     ...
     $busca_galeria="select * from galerias_i where codigo_galeria = '".$codigo_galeria."';";
...

     {
      ...
      $busca_foto="select * from foto_galerias_i where codigo_galeria = '".$codigo_galeria."' order by codigo_foto asc;";
