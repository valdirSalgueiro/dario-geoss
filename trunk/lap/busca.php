                    ...
                    <table width="468" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="imgalessandro6.jpg"><table width="622" border="0" align="left" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="20" background="images/bg.jpg"><span class="style26 style28"><span class="menu"><? if(($_SESSION['lang']=='Brazil')or($_SESSION['lang']=='')){	?></span><span class="style81">Busca
