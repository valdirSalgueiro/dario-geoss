...
if ($_POST['enviar'])
{
	...
	$id = $_GET['id'];
	$consulta = mysql_query("SELECT * FROM videos WHERE codigo_video = '".$id."'") or die(mysql_error());
...
. $_POST['remetente'] . " encontrou um video interessante e gostaria que você desse uma olhada:<br><br>Comentários do remetente:<br>" 
. $_POST['comentarios'] .
...
$corpo .= "<tr><td valign='top' class='legenda_foto' align='center' style='padding-top:15px padding:5px border:2px #EAEAEA dotted'><table width='100' border='0' cellspacing='0' cellpadding='0'><tr><td align='right'>Link:"
. $materias['link'] .
"</td></tr><tr><td align='center'>"
. $materias['desc_video'] . "</td> </tr></table></div></td></tr>";
...
include "inc/smtp.class.php";
    ...
    $Email->EmailDe="Videos@fifaBR.com.br";  //Seu email
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="37" colspan="3" align="right" bgcolor="#CCCCCC" class="titulo" style="padding-right:15px;">Envie este V&iacute;deo </td>
  </tr>
  <tr>
    <td width="2%">&nbsp;</td>
    <td width="27%">&nbsp;</td>
