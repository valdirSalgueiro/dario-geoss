              ...
              <tr>
                <td height="2"><table width="772" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="42%" class="style11 style1 style25"><span class="style25"><a href="videos.php">Videos</a> | <a href="expediente.php">Expediente</a> | <a href="colunistas.php">Colunistas</a> | <a href="contato.php">Fale Conosco</a> | <a href="#" onclick="javascript:window.external.AddFavorite('http://www.portalsentinela.com/','Portal Sentinela');">Favoritos</a></span></td>
...
<UL>
  ...
  <LI><A title="Rádio Sentinela Ao Vivo" 
            href="radio.php">Rádio Sentinela Ao Vivo</A></LI>
  <LI><A title="Rádio e TV Sentinela" 
            href="http://www.tvsentinela.com/" target="_blank">Rádio e TV Sentinela</A></LI>
    ...
    <LI><A title="V&iacute;deos" 
            ...
            href="chat" title="Chat" target="_blank">Chat</A></LI>
			      <LI><A 
            href="sugestoes.php" title="Sugestões">Sugestões</A></LI>
			      <LI><A 
            href="denuncie.php" title="Denuncie Aqui">Denuncie Aqui</A></LI>
			      <LI><A title="Notícias do Internauta" 
            href="ajude.php">Notícias do Internauta</A></LI>
                  <LI><A title="Notícias da Cidade" 
            href="not.php?codigo_categoria=1">Notícias de &Oacute;bidos </A></LI>
                  <LI><A title="Brasil" 
            href="not.php?codigo_categoria=2">Brasil</A></LI>
                  <LI><A title="Coluna Social" 
            href="not.php?codigo_categoria=3">Coluna Social  </A></LI>
                  <LI><A title="Amazônia Urgente" 
            href="not.php?codigo_categoria=4">Amazônia Urgente </A></LI>
                  <LI><A 
            href="previsao.php" title="Previsão do Tempo">Previs&atilde;o do Tempo  </A></LI>
                  <LI><A title="Cultura" 
		    ...
		    href="not.php?codigo_categoria=9">Tecnologia  </A></LI>
                                <LI><A title="Notícias da Região" 
            href="not.php?codigo_categoria=11">Notícias da Região</A></LI>
                  <LI><A title="Mundo" 
...
$campo_cat=mysql_fetch_array($res_busca_cat);
?>
          ...
          echo "<table border=0 class=fonte cellspacing=5><br>";
		  
		  		 //Contando o n&uacute;mero de coment&aacute;rios existentes
$consultac = mysql_query("SELECT count(codigo_noticia) as total FROM noticias where codigo_categoria = '".$_GET['codigo_categoria']."' and ativado='0'") or die(mysql_error());
$totalcom = mysql_result($consultac,0,"total");
         if($totalcom==0){ 
		 echo "N&atilde;o h&aacute; not&iacute;cias cadastradas.";  }
...

    {
...

     {
      ...
      $busca_noticia="select * from noticias e, categorias c where e.codigo_categoria = $_GET[codigo_categoria] and ativado='0' order by e.codigo_noticia desc limit 0,1;";
...

     {
      ...
      $busca_noticia="select * from noticias e, categorias c where e.codigo_categoria = $_GET[codigo_categoria] and e.nome_noticia like '%".$busca."%' and ativado='0' order by e.codigo_noticia desc limit 0,1;";
...

     {
...

      {
...

       {
        ...
        $busca_foto="select * from foto_noticias where codigo_noticia = '".$campo_noticia[codigo_noticia]."' order by codigo_foto asc;";
...

        {
         ...
         $imagem_noticia="<img src=admin/$campo_foto[foto] name=PictureBox width=180 border=0><BR> ";

        }
        $campo_noticia[descricao_noticia] = substr($campo_noticia[descricao_noticia],0,160);
		
        echo "<tr><td width='100'>$imagem_noticia</td><td><font color=black><b><a href='noticia.php?codigo_noticia=$campo_noticia[codigo_noticia]'><b><br>$campo_noticia[nome_noticia]</b><BR>$campo_noticia[desc_not]</a></b></font><BR><font class=materia>$campo_noticia[descricao_noticia]...</font><BR>

		

		<font class=materia>por em $campo_noticia[data_cadastro]</font>

		<br>
		<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='noticia.php?codigo_noticia=$campo_noticia[codigo_noticia]'><font class='materia'><b>[Leia Mais]</b></font></a>
...

    {
     ...
     $busca_noticia="select * from noticias e , categorias c where e.codigo_noticia = '".$codigo_noticia."' and ativado='0' and c.codigo_categoria = e.codigo_categoria;";

     $res_busca_produto=mysql_query($busca_noticia,$conn);
    ...
    echo "</table>";
	         		 ...
	         		 //Contando o n&uacute;mero de coment&aacute;rios existentes
$consultac = mysql_query("SELECT count(codigo_noticia) as total FROM noticias where codigo_categoria = '".$_GET['codigo_categoria']."'") or die(mysql_error());
$totalcom = mysql_result($consultac,0,"total");	
         ...
         if($totalcom!=0){ 
		  ...
		  $busca_noticia= "SELECT * FROM noticias where ativado=0 and codigo_noticia != $campo_noticia[codigo_noticia] and codigo_categoria = $_GET[codigo_categoria] order by codigo_noticia DESC;";
...

          {
...

           {
...

            {
             ...
             echo "<td><font size=2 class='materia' color=black><b>".$campo_noticia[data_cadastro]."</b></font><br>";
             echo "<a href='noticia.php?codigo_noticia=$campo_noticia[codigo_noticia]'><font size=2 class='materia' color=#0000CC>".$campo_noticia[nome_noticia]."</font></td>
          ...
          ?>
                                <table width="458" border="0">
                                  ...
                                  <tr>
                                    <td bgcolor="#FFFFFF" class="style22 style32"><table width="458" border="0">
                                      <tr>
                                        <td width="452" bgcolor="#CCCCCC" class="style22 style32">Publicidade<strong></strong></td>
                                        </tr>
                                      </table></td>
                                    </tr>
                                  <tr>
...
//Buscando o tipo do Banner : Imagem, Flash ou Google									  
   ...
   $campo_banner=mysql_fetch_array($res_busca_banner);
   
 if($campo_banner['tipo']=='img'){             
	  
//Contando o n&uacute;mero de foto_do_dia existentes
$consulta_propaganda = mysql_query("SELECT count(codigo_banner_noticias) as total FROM foto_banner_noticias WHERE codigo_banner_noticias='".$_GET[codigo_categoria]."'") or die(mysql_error());
$total_propaganda = mysql_result($consulta_propaganda,0,"total");
         if($total_propaganda==0){ 
  		
		  echo "<font class=materia>N&atilde;o h&aacute; Banner Cadastrado.</font>";  }
          echo "<table border=0 class=fonte width=100 cellspacing=0>";
          echo "<tr>";
          echo "<td>";
          ...
          echo "<center><a href=admin/$campo_foto[foto] rel=lightbox title=$campo_foto[descricao_foto]><img src=admin/$campo_foto[foto] name=PictureBox width=456 height=60 border=0></a><BR>";
             }
...
if($totalcat==0){ echo "<br><br>Não há notícias cadastradas nesta categoria."; } else {
...

    {
...

     {
      ...
      $busca_noticia="select * from noticias e, categorias c where c.codigo_categoria = e.codigo_categoria and e.codigo_categoria = '".$_GET['codigo_categoria']."' order by e.visualizacoes desc limit 0,8;";
...

     {
      ...
      $busca_noticia="select * from noticias e, categorias c where c.codigo_categoria = e.codigo_categoria and e.nome_noticia like '%".$busca."%' order by e.visualizacoes desc limit 0,4;";
...

      {
...

       {
...

        {
         ...
         $imagem_noticia="<img src=admin/$campo_foto[foto] name=PictureBox width=80 border=0><BR> ";

        }

       
        echo "<tr><td width='100'>$imagem_noticia</td><td><font color=black class=materia><b><a href='noticia.php?codigo_noticia=$campo_noticia[codigo_noticia]'><b>$campo_noticia[nome_noticia]</b><BR></a></b>$campo_noticia[desc_not]<br>$campo_noticia[data_cadastro] - $campo_noticia[hora_cadastro] <BR>

		

		Esta notícia teve : <b>$campo_noticia[visualizacoes]</b> Visualizações</font>
...

    {
     ...
     $busca_noticia="select * from noticias e , categorias c where e.codigo_noticia = '".$codigo_noticia."' and c.codigo_categoria = e.codigo_categoria;";
    ...
    echo "</table>";
          ...
          ?>
                                  ...
                                  <br />
                                  <strong><em><a href="noticias.php" class="style22 style22 style25 style25 style29"></a></em></strong>
                                <table width="337" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td><div align="center"><strong><em><a href="noticias.php" class="style22 style22 style25 style25 style29">[ CLIQUE AQUI para Abrir Arquivo de Not&iacute;cias]</a></em></strong></div></td>
                                  </tr>
                                </table>
                              </div></td>
                            </tr>
                  ...
                  <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                      <td height="68" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style11 style25"><strong>&nbsp;<span class="style33">Enquete:</span></strong></div></td>
                        </tr>
                      </table>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td height="68" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style11 style25"><strong>&nbsp;<span class="style33">Foto do Dia  :</span></strong></div></td>
                          </tr>
                        </table>
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                    ...
                    <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td height="68"><div align="center" class="style21">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style25 style25"><strong>&nbsp;<span class="style33">Publicidade:</span></strong></div></td>
                              </tr>
                            </table>
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
