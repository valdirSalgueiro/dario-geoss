...

{
 ...
 $busca_noticia="select * from tabelas where id = '".$codigo_noticia."';";
...

{
...

 {
  ...
  $busca_noticia="select * from tabelas where nome = '".$nome."';";
...

 {
  ...
  $mod_noticia = "update tabelas set nome = '".$nome."' where id = '".$codigo_noticia."';";
...

  {
   ...
   echo "<script>alert('A Tabela $nome foi alterada com sucesso.');

   window.location='mod_tipo_tab2.php?id=$codigo_noticia';</script>";
...

 {
  ...
  echo "<script>alert('A Tabela: $nome já existe.');</script>";
