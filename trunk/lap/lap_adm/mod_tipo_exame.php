...
<form name=form1 method=post>
  ...
  <h1 class="style3"><font face=verdana><img src="images/alterar.png" width="48" height="48"> Modificar Tipo de Exame:</font></h1>
...
<tr>
  ...
  <td><select name="nome" class="caixa" id="nome" onChange="submitar()">
   ...
   printf("<option value='$_POST[tipo]'>$_POST[tipo]");
    ...
    <?
$busca_conv="select * from tipo_exame WHERE nome!= '".$_POST[tipo]."' order by nome asc;";
...
if ($_POST['todos']) 
{
 $busca_noticia="select * from tipo_exame order by id_ex asc;";
...

 {
...

  {
   ...
   echo "<tr height=20><td bordercolor=white><a href='mod_tipo_exame2.php?id=$campo_noticia[id_ex]'>$campo_noticia[nome]</a></td></tr>";
...

 {
  ...
  echo "Não foi encontrado nenhum tipo de exame com o nome <b>$nome</b>.";
...

{
 ...
 $busca_noticia="select * from tipo_exame where nome like '%".$nome."%' order by id_ex asc;";
