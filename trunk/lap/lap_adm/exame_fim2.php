...
<table width="866" border="0">
  <tr>
    <td width="860" class="fonte_link"><table width="862" border="0">
      <tr>
        <td width="396" class="fonte_link"><img src="timbrado.PNG" width="291" height="86" /></td>
...
<table width="866" border="0" bordercolor="#331A1C">
  ...
  <tr>
    <td height="77" colspan="4" class="fonte_link style64"> <tr> <table width="860" border="0">
        <tr>
          <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><tr><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><tr><br /><br /><td width="831" class="style80"><hr width="860" size="4" color="black" /></td>
        </tr>
      </table>
<div>
