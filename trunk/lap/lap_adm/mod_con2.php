...

{
 ...
 $busca_noticia="select * from codigo_conc where id = '".$codigo_noticia."';";
...
<h1 class="style1"><font face=verdana>Modificar C&oacute;digo de Conclus&atilde;o:</font></h1>
...
<tr>
  ...
  <td width="405"><input name=codigo type=text class=botao id="codigo" value="<?echo $campo_noticia[codigo];?>" size=50 maxlength=100></td>
</tr>
...

{
...

 {
  ...
  $busca_noticia="select * from codigo_conc where codigo = '".$codigo_procedimento."';";
...

 {
  ...
  $mod_noticia = "update codigo_conc set codigo = '".$codigo_procedimento."',descricao = '".$descricao."' where id = '".$codigo_noticia."';";
...

  {
   ...
   echo "<script>alert('O Código de Conclusão $codigo_procedimento foi alterado com sucesso.');

   window.location='mod_con2.php?id=$codigo_noticia';</script>";
...

 {
  ...
  echo "<script>alert('O Código : $codigo_procedimento já existe.');</script>";
