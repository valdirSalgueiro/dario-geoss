...
if($_POST['medico']==NULL){
 ...
 $busca_ex.="select * from exame  WHERE data_previsao > $stimestamp and data_previsao < $etimestamp and ex_status_id !=3  or data_previsao > $stimestamp and data_previsao < $etimestamp   and ex_status_id !=3 order by id asc;";
