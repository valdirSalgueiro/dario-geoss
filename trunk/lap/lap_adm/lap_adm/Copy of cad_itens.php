...
<h1 class="style3"><font face=verdana>Cadastrar Itens de Exame:</font></h1>
...

{
...

 {
  ...
  echo "<script>alert('O Item de Exame: $nome já está cadastrado.');</script>";
...
<table border=0 class=fonte>
  <tr>
    <td width="492" colspan="2" bgcolor="#333333"><div align="center" class="style4">Itens de Exame  Cadastrados </div>
        <div align="center"></div>
    <div align="center"></div></td>
    <?
	$sql = "SELECT * FROM itens_exame order by id ASC";
