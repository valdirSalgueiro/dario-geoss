...
<form name=form1 method=post>
  ...
  <h1 class="style3"><font face=verdana><img src="images/alterar.png" width="48" height="48"> Modificar Convenio:</font></h1>
...
if ($_POST['todos']) 
{
 $busca_noticia="select * from convenio order by id asc;";
...

 {
  ...
  echo "<tr><th bordercolor=white>Nome Convenio</th></tr>";
...

  {
   ...
   echo "<tr height=20><td bordercolor=white><a href='mod_conv2.php?id=$campo_noticia[id]'>$campo_noticia[nome]</a></td></tr>";
...

 {
  ...
  echo "Não foi encontrado nenhum convenio com o nome <b>$nome</b>.";
...

{
 ...
 $busca_noticia="select * from convenio where nome like '%".$nome."%' order by id asc;";
