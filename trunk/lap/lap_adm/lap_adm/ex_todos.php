...
<tr>
  <td>Filtrar Por:</td><td><select name="nome" class="caixa" id="nome">
    <?
...

 {
...

  {
   ...
   $campo_pa=mysql_fetch_array($res_busca_pa);
     ...
     echo "<tr height=20><td bordercolor=white><a href='laudos.php?id=$campo_ex[id]'>$campo_ex[id]</td><td bordercolor=white>$campo_pa[nome]</td><td bordercolor=white>&nbsp;&nbsp;$campo_ex2[nome]</td><td bordercolor=white>&nbsp;&nbsp;<a href='exame.php?id=$campo_ex[id]' target='_blank'>Print</td></a></tr>";
...

{
...

 {
  ...
  echo "<tr><th bordercolor=white>Laudo Número</th><th bordercolor=white>Nome Paciente</th><th bordercolor=white>STATUS</th></tr>";
...
//Busca o Status do ID
   ...
   echo "<tr height=20><td bordercolor=white><a href='laudos.php?id=$campo_ex[id]'>$campo_ex[id]</td><td bordercolor=white>$campo_pa[nome]</td></a></td><td bordercolor=white>$campo_ex2[nome]</td></tr>";
