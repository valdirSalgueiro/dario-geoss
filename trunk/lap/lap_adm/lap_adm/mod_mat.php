...
<form name=form1 method=post>
  ...
  <h1 class="style3"><font face=verdana><img src="images/alterar.png" width="48" height="48"> Modificar Material:</font></h1>
...
if ($_POST['todos']) 
{
 $busca_noticia="select * from material order by id asc;";
...

 {
...

  {
   ...
   echo "<tr height=20><td bordercolor=white><a href='mod_mat2.php?id=$campo_noticia[id]'>$campo_noticia[nome]</a></td></tr>";
...

 {
  ...
  echo "Não foi encontrado nenhum material com o nome <b>$nome</b>.";
...

{
 ...
 $busca_noticia="select * from material where nome like '%".$nome."%' order by id asc;";
