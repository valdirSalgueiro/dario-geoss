...
<tr>
  <td class="style10">Servi&ccedil;os de :</td>
  <td><input type=text name=servicos class=botao size=50 maxlength=50 id="servicos">
...
echo "É obrigatório o preenchimento de todos os campos."; } else {
 ...
 echo "<script>window.open('print_recibo.php?id=$_POST[id]&&nome=$_POST[nome]&&valor=$_POST[valor]&&servicos=$_POST[servicos]');</script>";
