...

{
 ...
 $busca_noticia="select * from codigo where id = '".$codigo_noticia."';";
...

{
...

 {
  ...
  $busca_noticia="select * from codigo where codigo = '".$codigo_procedimento."';";
...

 {
  ...
  $mod_noticia = "update codigo set codigo = '".$codigo_procedimento."',descricao = '".$descricao."' where id = '".$codigo_noticia."';";
...

  {
   ...
   echo "<script>alert('O Código de Microscopia $codigo_procedimento foi alterado com sucesso.');

   window.location='mod_mic2.php?id=$codigo_noticia';</script>";
