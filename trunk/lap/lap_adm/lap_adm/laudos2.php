...
<tr>
  ...
  <td><span class="style10"><?php echo $campo_pac['nome']; ?>    </span></td>
</tr>
...
<tr>
  ...
  <td><span class="style10"><?php echo date("d-m-Y-H:h",$campo_ex['data_previsao']); ?></span></td>
</tr>
<tr>
...
<tr>
  ...
  <td><span class="style10">
    <input name=material type=text class=botao id="material" value="<?php echo $campo_ex['material']; ?>" size=50 maxlength=50>
  </span></td>
</tr>
<tr>
...
<tr>
  ...
  <td><span class="style10">
    <textarea name="macroscopia" id="macroscopia" cols="40" rows="4"><?php echo $_SESSION["macroscopia"]; echo $_GET['codigo_mac']; ?></textarea>
  </span></td>
</tr>
<tr>
...
<tr>
  ...
  <td><span class="style10">
    <textarea name="microscopia" id="microscopia" cols="40" rows="4"><?php echo $_SESSION["microscopia"]; ?></textarea>
  </span></td>
</tr>
<tr>
...
<tr>
  ...
  <td><span class="style10">
    <textarea name="conclusao" id="conclusao" cols="40" rows="4"><?php echo $_SESSION["codigo_conc"]; ?>
    </textarea>
  </span></td>
</tr>
<tr>
...
<tr>
 <td><span class="style10">Procedimentos Necessários ?</span></td><td> <input name="1" type="submit" class="botao" id="mais" value="1"><input name="2" type="submit" class="botao" id="mais" value="2"><input name="3" type="submit" class="botao" id="mais" value="3"></td></tr>
...
<tr>
  ...
  <td><span class="style10"><?php echo $campo_conv['nome']; ?></span></td>
</tr>
<tr>
...
<tr><td></td><?php } ?>
  <td><span class="style10">
    ...
    <td><input name="fin1" type=submit class=botao id="fin1" value='Atualizar'> 
...
printf("<script>alert('Este exame está sendo fechado. Não poderá mais fazer alterações. ');window.location='laudos.php?id=$id';</script>");
