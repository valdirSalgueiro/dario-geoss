...
<h1 class="style1"><font face=verdana><img src="images/forum_old.gif" width="29" height="30"> Pesquisar C&oacute;digo Microscopia:</font></h1>
...
$nome=$_POST['nome'];
...

 {
...

  {
   ...
   echo "<tr height=20><td bordercolor=white><a href='detalhes_cod.php?id=$campo_cod[id]'>$campo_cod[codigo] </a></td><td bordercolor=white>$campo_cod[descricao]</td></tr>";
...

{
 ...
 $busca_cod="select * from codigo where";
