...
<h1 class="style1"><font face=verdana><img src="images/usuarios.jpg" width="50" height="50"> Exames em Andamento:</font></h1>
...
$ex_status_id=$_POST['ex_status_id'];
 ...
 $busca_ex.="select * from exame where ex_status_id=2 order by id asc;";
