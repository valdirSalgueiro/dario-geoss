...
if(($_POST['reimp']=='entrega')and($_POST['imp']=='laser')){

echo "<script>window.open('print.php?id=$_POST[id]');</script>";

}
if(($_POST['reimp']=='gsl')and($_POST['imp']=='laser')){

echo "<script>window.open('exame.php?id=$_POST[id]');</script>";

}
if(($_POST['reimp']=='copia')and($_POST['imp']=='laser')){

echo "<script>window.open('copia.php?id=$_POST[id]');</script>";

}
if(($_POST['reimp']=='impressao_neap')and($_POST['imp']=='laser')){
...
if(($_POST['reimp']=='exame')and($_POST['imp']=='laser')){
...
//Impressão na lx300
if(($_POST['reimp']=='entrega')and($_POST['imp']=='lx300')){

echo "<script>window.open('print_lx300.php?id=$_POST[id]');</script>";

}
if(($_POST['reimp']=='gsl')and($_POST['imp']=='lx300')){

echo "<script>window.open('exame_lx300.php?id=$_POST[id]');</script>";

}
if(($_POST['reimp']=='copia')and($_POST['imp']=='lx300')){

echo "<script>window.open('copia_lx300.php?id=$_POST[id]');</script>";

}
if(($_POST['reimp']=='impressao_neap')and($_POST['imp']=='lx300')){
...
if($campo_ex['ex_status_id']!=3){
if(($_POST['reimp']=='exame')and($_POST['imp']=='lx300')){

echo "<script>window.open('exame_fim_lx300.php?id=$_POST[id]');</script>";
} 
}
if($campo_ex['ex_status_id']==3){
if(($_POST['reimp']=='exame')and($_POST['imp']=='lx300')){
...
<tr>
  <td class="style10"><strong>Impressora para reimprimir:</strong></td>
</tr>
<tr>
  <td><input type="radio" name="imp" id="radio" value="lx300">
      <span class="style10">LX300+</span></td>
</tr>
<tr>
  <td><input type="radio" name="imp" id="entrega" value="laser">
      <span class="style10">Laser</span></td>
</tr>
<tr>
  <td class="style10">&nbsp;</td>
</tr>
<tr>
  <td width="291" class="style11">Documento para reimprimir:</td>
  </tr>
