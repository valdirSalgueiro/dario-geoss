                ...
                <td height="464" valign="top"><table width="468" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="imgalessandro6.jpg"><table width="468" border="0" align="left" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="20" background="images/bg.jpg"><span class="style26 style28"><span class="menu"><? if(($_SESSION['lang']=='Brazil')or($_SESSION['lang']=='')){	?></span><span class="style81">Sugest&otilde;es
                              <? } if($_SESSION['lang']=='eng') { ?>
                            </span></span><span class="style81"><strong>Sugest&otilde;es</strong>
                            <? } if($_SESSION['lang']=='esp') { ?>
                            <strong>Sugest&otilde;es</strong></span>
                            <? } ?>
                            </span></span></td>
                          </tr>
                        </table></td>
                    ...
                    <table width="468" height="207" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
						...
						<table width="464" border="0" cellspacing="0" cellpadding="0">
                          <tr>
						    <td height="200" background=""><div align="center"><span style="border:2px #EAEAEA dotted;"><span class="materia">&Aacute;rea em que voce pode deixar a sua sugest&atilde;o para o Portal Sentinela. </span></span></div>
					          <span style="border:2px #EAEAEA dotted;"><span class="materia"><img src="images/users_family.jpg" width="48" height="48" align="left" /></span></span><br />
					        <br />
					        <br />
					        <?
...
?>
                            <table width="94%" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="587" bgcolor="#CCCCCC" style="border:2px #EAEAEA dotted;"><img src="images/ico_meus_documentos.gif" width="36" height="36" align="left" /> <span class="titulo"> Sugest&otilde;es   [ <? print $totalcom; ?> ] </span><span class="materia"></span><br />
                                    <br />
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="21%" class="por">&nbsp;</td>
                                        <td width="79%" align="right"><a href="javascript:env_perg('<?=$materias['codigo_noticia'] ?>')" class="l_menu_materia"> Enviar Sugest&atilde;o </a></td>
                                      </tr>
                                  </table></td>
                              </tr>
                              <tr>
                                <td valign="top" class="legenda_foto" align="center" style="padding-top:15px; padding:5px; border:2px #EAEAEA dotted;">&nbsp;</td>
                              </tr>
                              <tr>
                                <?
		$consulta = mysql_query("SELECT * FROM tab_perguntas ORDER BY id_cmt DESC") or die(mysql_error());
...
?>
                                <td valign="top" class="legenda_foto" align="center" style="padding-top:15px; padding:5px; border:2px #EAEAEA dotted;"><div align="left" class="materia">
                                    <table border="0" cellpadding="0" cellspacing="0" width="459" height="42">
                                      <tr>
                                        <td width="566" valign="top" bgcolor="#FFCCCC" style="border: 1px dashed #CC0000"><p align="left" class="materia"><strong><b> S
                                                  <?=$comentarios['id_cmt']?>
                                          &nbsp;.&nbsp;&nbsp;<img src="images/bloco.gif" width="23" height="20" />
...
?>
                            ...
                            <p style="padding:10px; padding-top:0px;"><span class="materia">
                              <? if($totalcom==0){ echo "<font class='materia'>Ainda n&atilde;o h&aacute; perguntas.</font>"; } ?>
                              <br />
                              <br />
                              <br />
                              <br />
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="142" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td height="68" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="98" height="20" background="images/bg.jpg" class="style27"><div align="left" class="style11 style25"><strong><span class="menu"><? if(($_SESSION['lang']=='Brazil')or($_SESSION['lang']=='')){	?></span><span class="style81">Foto do Dia :<span class="style26 style28">
                              <? } if($_SESSION['lang']=='eng') { ?>
