...
$busca_mate="SELECT * FROM videos WHERE codigo_video = '".$codigo_video."' ORDER BY codigo_video DESC;";
$res_busca_mate=mysql_query($busca_mate,$conn);
$campo_mate=mysql_fetch_array($res_busca_mate);

$soma = $campo_mate['visualizacoes']+1;
if(!$_POST['voltar']){
$up2 = mysql_query("UPDATE videos SET  visualizacoes='".$soma."' WHERE codigo_video = '".$codigo_video."' ") or die(mysql_error());
}
