...
<?php
		if ($result = $db->query($query)) {
			while ($obj = $result->fetch_object()) {			
				...
				echo "<td><a href=\"cadservicos.php?id=$servicos->id\" class=\"glyphicon glyphicon-edit\"></a></td><td><a href=\"remover.php?type=servicos&id=$servicos->id\" class=\"glyphicon glyphicon-remove\"></a></td></tr>";
			}
