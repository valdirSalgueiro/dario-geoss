...
<?php
		if ($result = $db->query($query)) {
			while ($obj = $result->fetch_object()) {			
				...
				echo "<td><a href=\"cadorigem_ocorrenc.php?id=$origem_ocorrenc->id\" class=\"glyphicon glyphicon-edit\"></a></td><td><a href=\"remover.php?type=origem_ocorrenc&id=$origem_ocorrenc->id\" class=\"glyphicon glyphicon-remove\"></a></td></tr>";
			}
