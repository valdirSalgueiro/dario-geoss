...
?>
	...
	<div class="form-group col-md-12" style="text-align: left">
				...
				?>
				Faturado <input type="checkbox" name="faturado" value="1" <?php echo $checked ?>>
			                  
		</div>
		
	<div class="form-group col-md-12" style="text-align: left">
				<?php
				$checked=($conta->pagar)?"checked":"";
				?>
				Pagar <input type="checkbox" name="pagar" value="1" <?php echo $checked ?>>
	...
	<div class="form-group col-md-12" style="text-align: left">
							<input type="text" name="valor_repetir" class=" form-control input-sm"  placeholder="Valor repetir" value="<?php echo $conta->valor_repetir?>">
