...
?>
      ...
      <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
			<form role="form"  action="dao.php" onSubmit="return ajaxSubmit(this,'Aluno cadastrado com sucesso');">
	...
	<div class="form-group col-md-12">
                <input type="text" name="data_nasc" class="form-control input-sm" placeholder="Data nasc" value="<?php echo $aluno->data_nasc?>">
