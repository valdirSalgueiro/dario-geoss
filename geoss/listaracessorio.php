...
<?php
		if ($result = $db->query($query)) {
			while ($obj = $result->fetch_object()) {			
				...
				echo "<td><a href=\"cadacessorio.php?id=$acess_equipam->id\" class=\"glyphicon glyphicon-edit\"></a></td><td><a href=\"remover.php?type=acess_equipam&id=$acess_equipam->id\" class=\"glyphicon glyphicon-remove\"></a></td></tr>";
			}
