...
<?php
		if ($result = $db->query($query)) {
			while ($obj = $result->fetch_object()) {			
				...
				echo "<td><a href=\"cadorigem_ocorrenc.php?id=$origem_ocorrenc->id\" class=\"glyphicon glyphicon-edit\"></a></td><td><a href=\"javascript:apagar(\"origem_ocorrenc\",$origem_ocorrenc->id)\" class=\"glyphicon glyphicon-remove\"></a></td></tr>";
			}
