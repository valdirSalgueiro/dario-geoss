...
<?php
		if ($result = $db->query($query)) {
			while ($obj = $result->fetch_object()) {			
				...
				echo "<td><a href=\"cadservicos.php?id=$servicos->id\" class=\"glyphicon glyphicon-edit\"></a></td><td><a href=\"javascript:apagar(\"servicos\",$servicos->id)\" class=\"glyphicon glyphicon-remove\"></a></td></tr>";
			}
