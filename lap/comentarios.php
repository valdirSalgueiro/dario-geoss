...
if ($_POST['enviar']) {
	...
	$m = date("i");
	$hora = $h.":".$m;
	mysql_query("INSERT INTO tab_comentarios (codigo_noticia, nome_cmt, email_cmt, texto_cmt, data_cmt, hora_cmt, autorizado) VALUES ('".$_GET['id']."', '".$_POST['nome']."', '".$_POST['email']."', '".$_POST['comentario']."', '".$data."', '".$hora."', '0') ") or die(mysql_error());
?>
<script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#006600">
  <tr>
    <td background="images/bg.jpg" style="padding:10px"><div align="center" class="style1">COMENT&Aacute;RIOS</div></td>
  </tr>
</table><br />
<br />
