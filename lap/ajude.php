              ...
              <tr>
                <td height="2"><table width="772" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="44%" class="style11 style1 style25"><span class="style25"><a href="videos.php">Videos</a> | <a href="expediente.php">Expediente</a> | <a href="colunistas.php">Colunistas</a> | <a href="contato.php">Fale Conosco</a>  | <a href="#" onClick="javascript:window.external.AddFavorite('http://www.portalsentinela.com/','Portal Sentinela');">Favoritos</a></span></td>
          ...
          <td height="59" class="style22"><table width="152" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  		 ...
		  		 //Contando o n&uacute;mero de foto_do_dia existentes
$consulta_propaganda = mysql_query("SELECT count(codigo_propaganda) as total FROM propaganda WHERE nome_propaganda='7'") or die(mysql_error());
$total_propaganda = mysql_result($consulta_propaganda,0,"total");
         if($total_propaganda==0){ 
		 echo "<font class=materia>Espa&ccedil;o Reservado.</font>";  }
...

          {
...

           {
...

            {
             ...
             $busca_foto="select * from foto_propaganda where codigo_propaganda = '7' order by rand();";
          ...
          <td height="59" class="style22"><table width="152" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  		 ...
		  		 //Contando o n&uacute;mero de foto_do_dia existentes
$consulta_propaganda = mysql_query("SELECT count(codigo_propaganda) as total FROM propaganda WHERE nome_propaganda='8'") or die(mysql_error());
$total_propaganda = mysql_result($consulta_propaganda,0,"total");
         if($total_propaganda==0){ 
		 echo "<font class=materia>Espa&ccedil;o Reservado.</font>";  }
...

          {
...

           {
...

            {
             ...
             $busca_foto="select * from foto_propaganda where codigo_propaganda = '8' order by rand();";
          ...
          <td height="59" class="style22"><table width="152" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  		 ...
		  		 //Contando o n&uacute;mero de foto_do_dia existentes
$consulta_propaganda = mysql_query("SELECT count(codigo_propaganda) as total FROM propaganda WHERE nome_propaganda='9'") or die(mysql_error());
$total_propaganda = mysql_result($consulta_propaganda,0,"total");
         if($total_propaganda==0){ 
		 echo "<font class=materia>Espa&ccedil;o Reservado.</font>";  }
...

          {
...

           {
...

            {
             ...
             $busca_foto="select * from foto_propaganda where codigo_propaganda = '9' order by rand();";
          ...
          <td height="59" class="style22"><table width="152" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  		 ...
		  		 //Contando o n&uacute;mero de foto_do_dia existentes
$consulta_propaganda = mysql_query("SELECT count(codigo_propaganda) as total FROM propaganda WHERE nome_propaganda='10'") or die(mysql_error());
$total_propaganda = mysql_result($consulta_propaganda,0,"total");
         if($total_propaganda==0){ 
		 echo "<font class=materia>Espa&ccedil;o Reservado.</font>";  }
...

          {
...

           {
...

            {
             ...
             $busca_foto="select * from foto_propaganda where codigo_propaganda = '10' order by rand();";
          ...
          <td height="59" class="style22"><table width="152" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  		 ...
		  		 //Contando o n&uacute;mero de foto_do_dia existentes
$consulta_propaganda = mysql_query("SELECT count(codigo_propaganda) as total FROM propaganda WHERE nome_propaganda='11'") or die(mysql_error());
$total_propaganda = mysql_result($consulta_propaganda,0,"total");
         if($total_propaganda==0){ 
		 echo "<font class=materia>Espa&ccedil;o Reservado.</font>";  }
...

          {
...

           {
...

            {
             ...
             $busca_foto="select * from foto_propaganda where codigo_propaganda = '11' order by rand();";
          ...
          <td height="59" class="style22"><table width="152" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  		 ...
		  		 //Contando o n&uacute;mero de foto_do_dia existentes
$consulta_propaganda = mysql_query("SELECT count(codigo_propaganda) as total FROM propaganda WHERE nome_propaganda='12'") or die(mysql_error());
$total_propaganda = mysql_result($consulta_propaganda,0,"total");
         if($total_propaganda==0){ 
		 echo "<font class=materia>Espa&ccedil;o Reservado.</font>";  }
...

          {
...

           {
...

            {
             ...
             $busca_foto="select * from foto_propaganda where codigo_propaganda = '12' order by rand();";
              ...
              <tr>
                <td height="464" valign="top"><table width="50" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="images/bg.jpg"><span class="style26 style28">&nbsp;<span class="style33">Ajude o Sentinela  </span></span></td>
                      </tr>
                    </table>
                    <table width="468" height="207" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="143" valign="top"><table width="50" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="460" height="93">
                            <tr>
                              <td width="566" valign="top" bgcolor="#FFFFFF" style="border: 1px dashed #CC0000"><p align="center"><b> <font color="#CC0000" size="2" face="Verdana"><span style="margin-left: 10px; margin-right: 10px"><img src="images/ico_meus_documentos.gif" alt=":: Buscar D&uacute;vida ::" width="36" height="36" border="0" /></span>AJUDE </font></b></p>
                                  <p align="center" style="margin-left: 10px; margin-right: 10px"><span class="materia">Voce tamb&eacute;m pode nos ajudar. Aqui voce pode cadastrar not&iacute;cias no Portal Sentinela. Chegou sua hora de colaborar.<br />
                                    Lembre-se antes que todas as not&iacute;cias aqui passam por revis&atilde;o tanto para verificar se est&aacute; cadastrado corretamente e para ver se estar tudo escrito corretamente. Para ajudar &eacute; so ter boa vontade e come&ccedil;ar a postar.<br />
                                    Lembrando tamb&eacute;m que o que voce postar&aacute; agora ter&aacute; que ter a aprova&ccedil;&atilde;o da ADMINISTRA&Ccedil;&Atilde;O. Estando tudo correto sua mat&eacute;ria ir&aacute; ao ar. Caso demore muito entre em contato conosco para verificar o que ocorreu. <strong><br />
                                      <br />
                                    </strong></span></p>
                                <form method="post" name="form1" id="form1">
                                    <h1 align="center" class="style25 style32"><font face="verdana" color='#ff9900'><b> Cadastrar Mat&eacute;ria:</b></font></h1>
                                    ...
                                    <table width="320" border="0" align="center">
                                      ...
                                      <tr>
                                        <td width="268" class="caixa"><div align="center"> <a href="admin/cad_materia.php" target="_blank">&nbsp;&nbsp;Cadastrar Not&iacute;cia </a> </div></td>
                                      </tr>
                                      <tr>
                                        <td>&nbsp;</td>
                                      </tr>
                                ...
                                <p align="center" style="margin-left: 10px; margin-right: 10px"><span class="materia"><strong> </strong> <br />
                                    </span><b><font face="Verdana" size="2" color="#CC0000"><br />
                                      &nbsp;</font></b><br />
                                </p></td>
                            </tr>
                          </table></td>
...

          {
...

           {
...

            {
             ...
             $busca_foto="select * from foto_foto_dia where codigo_foto_dia = '".$campo_foto_dia[codigo_foto_dia]."' order by rand();";
