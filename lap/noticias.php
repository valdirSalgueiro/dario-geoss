...
$totalmat = mysql_result($consulta2,0,"total");
		...
		if(($codigo_noticia==NULL)and($_GET[busca]==NULL))

		{

         echo "<br><form name=form1 method=post>

		 <input type=checkbox onclick='visivel(this,document.all.busca_noticia);'> Procurar Not&iacute;cia.

		 <div id='busca_noticia' style='display:none'>

		 <table border=0 class=fonte>

		 <tr><td>T&iacute;tulo da Not&iacute;cia:</td><td><input type=text name=busca class=botao size=20></td><td><input type=submit value=' Procurar ' class=botao></td></tr>
...
//######### FIM dados Paginação
	...
	$busca_noticia = "select * from noticias e, categorias c where c.codigo_categoria = e.codigo_categoria and ativado='0' order by e.codigo_noticia desc LIMIT $inicial, $numreg";
	$sql_conta = mysql_query("SELECT * FROM noticias");
...

     {
      ...
      $busca_noticia="select * from noticias e, categorias c where c.codigo_categoria = e.codigo_categoria and e.nome_noticia like '%".$busca."%' and ativado='0' order by e.codigo_noticia desc;";
...

     {
...

      {
...

       {
        ...
        echo "<tr><td width='100'>$imagem_noticia</td><td><font color=black><b><a href='noticia.php?codigo_noticia=$campo_noticia[codigo_noticia]'><b>$campo_noticia[nome_noticia]</b><BR>$campo_noticia[desc_not]</a></b></font><br>$campo_noticia[data_cadastro] - $campo_noticia[hora_cadastro] <BR>

		

		$campo_noticia[nome_categoria]

		<br><img src=images/$campo_noticia[pais].gif name=PictureBox border=0>
