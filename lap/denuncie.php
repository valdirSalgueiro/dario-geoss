                    ...
                    <table width="468" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="imgalessandro6.jpg"><table width="468" border="0" align="left" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="20" background="images/bg.jpg"><span class="style26 style28"><span class="menu"><? if(($_SESSION['lang']=='Brazil')or($_SESSION['lang']=='')){	?></span><span class="style81">Menu
                              <? } if($_SESSION['lang']=='eng') { ?>
                            </span></span><span class="style81"><strong>Menu</strong>
                            <? } if($_SESSION['lang']=='esp') { ?>
...
if ($_POST['enviar']) {
	...
	$m = date("i");
	$hora = $h.":".$m;
	mysql_query("INSERT INTO denuncia (nome_cmt, email_cmt, texto_cmt, data_cmt, hora_cmt, ativado) VALUES ('".$_POST['nome']."', '".$_POST['email']."', '".$_POST['comentario']."', '".$data."', '".$hora."', '1') ") or die(mysql_error());
?>
                    <script>
alert('Denuncia Enviada.')
window.opener.location = '<? echo "denuncie.php" ?>';
...
?>
                    <br />
                    <a href="ver_denuncia.php"><span class="materia">Para ver as den&uacute;ncias CLIQUE AQUI</span></a><br />
                    <br />
					</div>
					<table width="362" height="85" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td colspan="2" class="comentarios_responsabilidade" style="padding:5px;"><table width="468" border="0" align="left" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="20" background="images/bg.jpg"><span class="style26 style28"><span class="menu">
                              <? if(($_SESSION['lang']=='Brazil')or($_SESSION['lang']=='')){	?>
                              </span><span class="style81">Denuncie
                                <? } if($_SESSION['lang']=='eng') { ?>
                              </span></span><span class="style81"><strong>Report</strong>
                              <? } if($_SESSION['lang']=='esp') { ?>
                      ...
                      <tr>
                        <td colspan="2" class="comentarios_responsabilidade" style="padding:5px;"><div align="center">Insira abaixo a sua denuncia. Seja claro, evite rodeios e v&aacute; direto ao assunto.  A pergunta &eacute; de total responsabilidade   do membro que o inseriu. O&nbsp;<strong><a href="http://www.portalsentinela.com" target="_blank">Portal Sentinela </a></strong>&nbsp;reserva-se o direito de intervir em  mensagens contendo palavras de baixo escal&atilde;o, publicidade, cal&uacute;nia, inj&uacute;ria,   difama&ccedil;&atilde;o ou qualquer conduta que possa ser considerada criminosa. </div></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><textarea name="comentario" cols="36" rows="6" class="caixa" id="comentario"></textarea></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
