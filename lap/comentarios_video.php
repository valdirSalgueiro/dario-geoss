...
if ($_POST['enviar']) {
	...
	$m = date("i");
	$hora = $h.":".$m;
	mysql_query("INSERT INTO tab_comentarios_videos (codigo_video, nome_cmt, email_cmt, texto_cmt, data_cmt, hora_cmt, autorizado) VALUES ('".$_GET['id']."', '".$_POST['nome']."', '".$_POST['email']."', '".$_POST['comentario']."', '".$data."', '".$hora."', '0') ") or die(mysql_error());
?>
<script>
alert('Seu comentário foi enviado.')
window.opener.location = '<?php echo "ver_video.php?codigo_video=$_GET[id]" ?>';
window.close();
</script>
<?php
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
    <td style="padding:10px"><div align="center" class="titulo">COMENT&Aacute;RIOS V&Iacute;DEOS </div></td>
  </tr>
</table><br />
<br />
...
<table width="362" height="85" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" class="comentarios_responsabilidade" style="padding:5px;">
      ...
      <div align="center">        O coment&aacute;rio &eacute; de total responsabilidade   do membro que o inseriu. O&nbsp;<strong><a href="http://www.fifabr.com.br" target="_blank">FIFABRASIL</a></strong>&nbsp;reserva-se o direito de intervir em  mensagens contendo palavras de baixo escal&atilde;o, publicidade, cal&uacute;nia, inj&uacute;ria,   difama&ccedil;&atilde;o ou qualquer conduta que possa ser considerada criminosa. </div></td></tr>
  <tr>
