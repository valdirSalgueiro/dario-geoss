...

{
 ...
 $busca="select * from  galerias where nome_galeria like '%".$nome."%' order by nome_galeria asc;";
...

 {
  ...
  echo "<tr><th bordercolor=white>Título Galeria</th></tr>";
...

  {
   ...
   echo "<tr height=20><td bordercolor=white><a href='rem_galeria2.php?codigo_galeria=$campo[codigo_galeria]'>$campo[nome_galeria]</a></td></tr>";
