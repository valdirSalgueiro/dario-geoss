...
$busca_foto="select * from foto_propaganda where codigo_propaganda = '".$codigo_propaganda."' order by codigo_foto asc;";
...
<tr><td></td><td><input type=button class=botao value=" Adicionar Foto " onClick="window.location='cad_foto_propaganda.php?codigo_propaganda=<?phpecho $codigo_propaganda;?>';"><input type=button value="FIM" class=botao onClick="window.location='conteudo.php';"></td></tr>
...

{
 ...
 $del_foto="delete from foto_propaganda where";
...

 {
  ...
  echo "<script>window.location='mod_foto_propaganda.php?codigo_propaganda=$codigo_propaganda';</script>";
