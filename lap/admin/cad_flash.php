...
<h1><font face=verdana color='#ff9900'><b>Cadastrar Flash Banner Not&iacute;cias :</b></h1>
...

{
 ...
 echo "<tr><td>Link completo do flash:</td><td><input type=text name='descricao_foto' class=botao size=50 maxlength=100><BR></td></tr>";
...

{
 ...
 $erro=3;
    ...
    $cad_foto="insert into foto_banner_noticias values ('".$codigo_banner_noticias."','','".$descricao_foto."','".$dimencao."','','flash');";
...

 {
  ...
  echo "<script>alert('O flash foi adicionado com sucesso.');

  window.location='cad_flash.php?codigo_banner_noticias=$codigo_banner_noticias';</script>";
