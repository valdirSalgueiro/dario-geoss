...
<h1><font face=verdana color='#ff9900'><b>Modificar Usuário: <?echo $campo_usu[usu];?></b></font></h1><hr color=black size=2>
...
<tr><td bgcolor='#ff9900'>Usuário:</td><td><center><input type=checkbox name=cad_usu value=1 <?if($acesso[0]==1){echo "checked";}?>></center></td><td><p align="center"><input type=checkbox name=mod_usu value=1 <?if($acesso[1]==1){echo "checked";}?>></p></td><td><p align="center"><input type=checkbox name=rem_usu value=1 <?if($acesso[2]==1){echo "checked";}?>></p></td></tr>

<tr>
  <td bgcolor='#ff9900'>Galeria de Fotos:</td>
  <td><center><input type=checkbox name=cad_festa value=1 <?if($acesso[3]==1){echo "checked";}?>></center></td><td><p align="center"><input type=checkbox name=mod_festa value=1 <?if($acesso[4]==1){echo "checked";}?>></p></td><td><p align="center"><input type=checkbox name=rem_festa value=1 <?if($acesso[5]==1){echo "checked";}?>></p></td></tr>

<tr>
  <td bgcolor='#ff9900'>Notícias:</td>
  <td><center><input type=checkbox name=cad_not value=1 <?if($acesso[6]==1){echo "checked";}?>></center></td><td><p align="center"><input type=checkbox name=mod_not value=1 <?if($acesso[7]==1){echo "checked";}?>></p></td><td><p align="center"><input type=checkbox name=rem_not value=1 <?if($acesso[8]==1){echo "checked";}?>></p></td></tr>

<tr>
  <td bgcolor='#ff9900'>Enquete:</td>
  <td><center><input type=checkbox name=cad_cli value=1 <?if($acesso[9]==1){echo "checked";}?>></center></td><td><p align="center">&nbsp;</p></td><td><p align="center">&nbsp;</p></td></tr>
</table>

<table border=1 bordercolor=black class=fonte>

<tr><td bordercolor=white><input type=checkbox name=email value=1 <?if($acesso[10]==1){echo "checked";}?>>
  O usu&aacute;rio pode Cadastrar / Alterar Links R&aacute;dio.</td>
</tr>

<tr><td bordercolor=white><input type=checkbox name=recado value=1 <?if($acesso[11]==1){echo "checked";}?>> O usuário pode ler e responder os recados.</td></tr>

<tr><td bordercolor=white><input type=checkbox name=consulta value=1 <?if($acesso[12]==1){echo "checked";}?>>
  O usu&aacute;rio pode Cadastrar / Alterar expediente e Colunistas.</td>
</tr>

<tr>
  <td bordercolor=white><input name=foto_dia type=checkbox id="foto_dia" value=1 <?if($acesso[13]==1){echo "checked";}?>>
O usu&aacute;rio pode Cadastrar  Foto do Dia</td>
</tr>
<tr><td bordercolor=white><input type=checkbox name=instalacoes value=1 <?if($acesso[14]==1){echo "checked";}?>>
  O usu&aacute;rio pode Cadastrar  Foto Propaganda</td>
</tr>
<tr>
  <td bordercolor=white><input type=checkbox name=videos value=1 <?if($acesso[15]==1){echo "checked";}?>>
