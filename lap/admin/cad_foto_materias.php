...

{
 ...
 $busca_foto="select * from foto_noticias where codigo_noticia = '".$codigo_noticia."';";
...

{
...

 {
...

  {
...

   {
    ...
    $cad_foto="insert into foto_noticias values ('".$codigo_noticia."','','".$descricao_foto."','".$dimencao."','');";
...

    {
     ...
     $mod_foto="update foto_noticias set foto = '".$dir.mysql_insert_id().$ext."' where codigo_foto = '".mysql_insert_id()."';";
...

 {
  ...
  window.location='cad_foto_materias.php?codigo_noticia=$codigo_noticia';</script>";
