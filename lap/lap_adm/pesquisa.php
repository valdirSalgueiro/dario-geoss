...
<h1 class="style4"><font face=verdana><span class="style1"><img src="arquivos/BotaoLupa.jpg" width="48" height="48"></span> Pesquisa de Exames:</font></h1>
...
<tr>
  ...
  <td><input name="id" type="text" id="id" size="3"></td>
  <td>&nbsp;</td>
</tr>
<tr>
...
if($num_pac==0)
{
 printf("<option value=''>Nenhum Status encontrado</option>");
}
...

{
...

 {
  ...
  printf("<option value='$campo_pac[id]'>$campo_pac[nome]</option>");
