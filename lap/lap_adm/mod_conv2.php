...
<tr>
  <td>Tipo  : </td>
  <td><input name=tipo type=text class=botao id="tipo" value="<?echo $campo_noticia[tipo];?>" size=50 maxlength=100></td>
</tr>
...
*/
...

 {
  ...
  echo "<script>alert('O Convenio: $nome já existe.');</script>";
