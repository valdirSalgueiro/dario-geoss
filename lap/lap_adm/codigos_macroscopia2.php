...
<h1 class="style3"><font face=verdana><img src="images/itens de exame.gif" width="48" height="48"> C&oacute;digos Macroscopia:</font></h1>
...
<table border=0 class=fonte>
  <tr>
	...
	$sql = "SELECT * FROM codigo_mac where codigo like '%".$_POST['chave']."%'  order by id ASC";
	$result = mysql_query($sql);
	}
	  ?>
  </tr>
  <tr>
    <td colspan="2"><table width="649" border="1">
      <tr>
        <td width="55" class="style10">C&oacute;digo</td>
        <td width="91" class="style10">Palavra-Chave</td>
      ...
      <tr>
        ...
        <td class="atributos_titulo style9"><div align="center"><a href="ponte2.php?id=<?php echo $_GET['id'];?>&&codigo_mac=<?php echo $row['id']; ?>"><img src="images/chk_on.gif" width="19" height="20" border="0"></a></div></td><?php } ?>
      </tr>
    </table></td>
  </tr>
  <tr>
...
?>
<script>
window.opener.location = '<?php echo "ent.php?id=$_GET[id]" ?>';
window.close();
</script>
<?php
}
