...
function countExameNaoDigitados(){
$consulta_ex = mysql_query("SELECT count(id) as total FROM exame WHERE macroscopia='' and microscopia='' and conclusao=''") or die(mysql_error());
$total = mysql_result($consulta_ex,0,"total");
return $total;
 }
function countExameAberto(){
$consulta_ex = mysql_query("SELECT count(id) as total FROM exame WHERE ex_status_id= '1' or ex_status_id= '2'") or die(mysql_error());
$total = mysql_result($consulta_ex,0,"total");
return $total;
 }
 function countExameAndamento(){
$consulta_ex = mysql_query("SELECT count(id) as total FROM exame WHERE ex_status_id= '2'") or die(mysql_error());
$total = mysql_result($consulta_ex,0,"total");
return $total;
 }
 function countExameFechado(){
$consulta_ex = mysql_query("SELECT count(id) as total FROM exame WHERE ex_status_id= '3'") or die(mysql_error());
$total = mysql_result($consulta_ex,0,"total");
return $total;
 }
function countExameCancelado(){
$consulta_ex = mysql_query("SELECT count(id) as total FROM exame WHERE ex_status_id= '4'") or die(mysql_error());
$total = mysql_result($consulta_ex,0,"total");
return $total;
 }
