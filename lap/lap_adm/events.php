...
var arrM = new Array("Janeiro","Fevereiro","Março","Abril","Maio","Junnho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro")
var arrY = new Array()
    for (ii=0;ii<=4;ii++){
        arrY[ii] = yyyy - 2 + ii
    }
...
var dCount = 0
    for (ii=0;ii<=41;ii++){
        if (((ii<7)&&(arrN[ii]>20))||((ii>27)&&(arrN[ii]<20))){
            ...
            $sql = mysql_query ("SELECT * FROM agenda")or die ("erro:".mysql_error()); 
            
            $res=mysql_fetch_array($sql);
            
             ?>
            if ((arrN[ii]==<?php $res['dia']; ?>)&&(mm==<?php $res['mes']; ?>)&&(yyyy==<?php $res['ano']; ?>)){
