...

{
 ...
 $busca_foto="select * from foto_med where id = '".$id."';";
...
//FOTOS DO EXAME
	  ...
	  $busca_propaganda= "SELECT * FROM foto_exames where id='".$id."' order by codigo_foto ASC;";
        ...
        $num_propaganda=mysql_num_rows($res_busca_propaganda);
          ...
          echo "<table border=0 class=fonte width=900 cellspacing=0>";
...
echo "<br><br><center><img src=$campo_propaganda[foto] name=PictureBox width=200 height=200 border=0><BR>";

             echo "<font size=1 class='materia' color=black>".$campo_propaganda[descricao_foto]."</font>
...

{
...

 {
...

  {
...

   {
    ...
    $cad_foto="insert into foto_med values ('".$id."','','".$descricao_foto."','".$dimencao."','');";
...

    {
     ...
     $mod_foto="update foto_med set foto = '".$dir.mysql_insert_id().$ext."' where codigo_foto = '".mysql_insert_id()."';";
...

 {
  ...
  window.location='cad_foto_med.php?id=$id';</script>";
