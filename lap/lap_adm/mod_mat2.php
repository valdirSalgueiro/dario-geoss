...

{
 ...
 $busca_noticia="select * from material where id = '".$codigo_noticia."';";
...
<h1 class="style1"><font face=verdana>Modificar Material:</font></h1>
...

{
...

 {
  ...
  $busca_noticia="select * from material where nome = '".$nome."';";
...

 {
  ...
  $mod_noticia = "update material set nome = '".$nome."' where id = '".$codigo_noticia."';";
...

  {
   ...
   echo "<script>alert('O Material $nome foi alterado com sucesso.');

   window.location='mod_mat2.php?id=$codigo_noticia';</script>";
...

 {
  ...
  echo "<script>alert('O Material: $nome já existe.');</script>";
