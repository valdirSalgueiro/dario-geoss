...
<h1 class="style1"><font face=verdana><img src="images/forum_old.gif" width="29" height="30">Pesquisar C&oacute;digo Microscopia Avan&ccedil;ado:</font></h1>
...
<tr>
  ...
  <td width="203"><input name="palavra" type="text" id="palavra"></td></tr>
</table>
...

{
...

 {
  ...
  $busca_ex.=" microscopia like '%".$palavra."%'";
...

 {
  ...
  echo "<tr><th bordercolor=white>Laudo Número</th><th bordercolor=white>Nome Paciente</th><th bordercolor=white>Microscopia</th><th bordercolor=white>STATUS</th><th bordercolor=white>Imprimir</th></tr>";
...
//Busca o Status do ID
  ...
  echo "<tr height=20><td bordercolor=white><a href='laudos.php?id=$campo_ex[id]'>$campo_ex[id]</td><td bordercolor=white>$campo_pa[nome]</td><td bordercolor=white>$campo_ex[microscopia]</td><td bordercolor=white>&nbsp;&nbsp;$campo_ex2[nome]</td><td bordercolor=white>&nbsp;&nbsp;<a href='exame.php?id=$campo_ex[id]' target='_blank'>Print</td></a></tr>";
