...
<table width="866" border="0" bordercolor="#331A1C">
  ...
  <tr>
    ...
    <td class="fonte_link style64"><span class="style80"><? echo date ("d/m/Y",$campo_cod['data_previsao']); ?></span></td>
  </tr>
  <tr>
...
echo "<br><br><center><img src=$campo_propaganda[foto] name=PictureBox width=$campo_config[width] height=$campo_config[height] border=0><BR>";
  ...
  <tr>
    <td height="177" colspan="4" class="fonte_link style64"><p></p><br></td>
  </tr>
