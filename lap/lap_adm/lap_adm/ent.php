...
##Gerar o ID do exame de acordo com os cadastrados Até aqui##
    ...
    $cad_ex="insert into exame values ('','".$id_exame."','".$id_pac."','".$id_med."','','".$convenio."','".$campo_cod2['tipo']."','".$codigo_procedimento."','','','".$ex_status_id."','".$data_entrada."','".$data_previsao."','".$data_saida."','".$id_ex."','".$material."','".$lab."','".$macroscopia."','','".$microscopia."','','".$conclusao."','".$valor."','".$obs_entrada."','".$obs_saida."','','','','','','".$usuario_autenticado."','','');";
