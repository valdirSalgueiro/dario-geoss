...
if(($nome!=NULL)and($data_nascimento!=NULL)and($ddd_fone1!=NULL)and($fone_1!=NULL)and($convenio!=NULL)and($identif_convenio!=NULL))

{
...

 {
    ...
    $cad_pa="insert into paciente values ('','".$nome."','".$endereco."','".$bairro."','".$cidade."','".$uf."','".$cep."','".$cpf."','".$rg."','".$data_nascimento."','".$ddd_fone1."','".$fone_1."','".$ddd_fone2."','".$fone_2."','".$ddd_fone3."','".$fone_3."','".$convenio."','".$identif_convenio."','".$email."','".$data."');";
