...

{
 ...
 $busca_noticia="select * from codigo_mac where id = '".$codigo_noticia."';";
...
<h1 class="style1"><font face=verdana>Modificar C&oacute;digo de Macroscopia:</font></h1>
...

{
...

 {
  ...
  $busca_noticia="select * from codigo_mac where codigo = '".$codigo_procedimento."';";
...

 {
  ...
  $mod_noticia = "update codigo_mac set codigo = '".$codigo_procedimento."',descricao = '".$descricao."' where id = '".$codigo_noticia."';";
...

  {
   ...
   echo "<script>alert('O Código de Macroscopia $codigo_procedimento foi alterado com sucesso.');

   window.location='mod_mac2.php?id=$codigo_noticia';</script>";
