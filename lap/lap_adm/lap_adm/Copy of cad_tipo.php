...
<h1 class="style3"><font face=verdana>Cadastrar Tipo de Exame:</font></h1>
...
<table border=0 class=fonte>
  <tr>
    <td width="359" colspan="2" bgcolor="#333333"><div align="center" class="style4">Tipo de Exame Cadastrados
    </div>
