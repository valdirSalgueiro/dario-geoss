...
<form name=form1 method=post>
  ...
  <h1 class="style3"><font face=verdana><img src="images/alterar.png" width="48" height="48"> Modificar Itens de Exame:</font></h1>
...
if ($_POST['todos']) 
{
...

 {
...

  {
   ...
   echo "<tr height=20><td bordercolor=white><a href='mod_itens2.php?id=$campo_noticia[id]'>$campo_noticia[nome]</a></td></tr>";
...

 {
  ...
  echo "Não foi encontrado nenhum item de exame com o nome <b>$nome</b>.";
...

{
 ...
 $busca_noticia="select * from itens_exame where nome like '%".$nome."%' order by id asc;";
