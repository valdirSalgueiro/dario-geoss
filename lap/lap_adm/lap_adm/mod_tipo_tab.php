...
<form name=form1 method=post>
  ...
  <h1 class="style3"><font face=verdana><img src="images/alterar.png" width="48" height="48"> Modificar Tabela:</font></h1>
...
if ($_POST['todos']) 
{
...

 {
...

  {
   ...
   echo "<tr height=20><td bordercolor=white><a href='mod_tipo_tab2.php?id=$campo_noticia[id]'>$campo_noticia[nome]</a></td></tr>";
...

 {
  ...
  echo "Não foi encontrado nenhuma tabela com o nome <b>$nome</b>.";
...

{
 ...
 $busca_noticia="select * from tabelas where nome like '%".$nome."%' order by id asc;";
