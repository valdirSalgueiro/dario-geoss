...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmColour")) {
  $insertSQL = sprintf("INSERT INTO compromisso (`data`, hora, titulo, compromisso, cor) VALUES (%s, %s, %s, %s, %s)",
...
mysql_select_db($database_conn, $conn);
$query_rs_evento = "SELECT * FROM compromisso";
...
<table width="452" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="40" align="center" valign="middle" background="../imgs/fundo_top.jpg"><div align="center" class="barra style10"><strong>Cadastro de Evento </strong></div></td>
  </tr>
  <tr>
    <td height="491" valign="top" background="../imgs/fundo.jpg"><form action="<?php echo $editFormAction; ?>" id="frmColour" name="frmColour" method="POST">
      <table width="92%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="233"><input name="data" maxlength="10" id="f_date_c" readonly="1" size="9" class="caixaTexto" />
    ...
    Calendar.setup({
        ...
        <tr>
          ...
          <td width="86%" class="style7"><input name="hora" type="text" id="hora" size="30" /></td>
        </tr>
        <tr>
      ...
      <input readonly type="text" name="cor" value="" id="txtHexa" size=6 style="width:47px;font-size: 12px">
    
			  </td>
              <td width="84%"><a href="javascript:void(0)" id='bgColorPreview' onClick="showPalette(this,'document.body.style.color')"><img src="../imgs/spacer.gif"  border="0" alt=""></a></td>
            </tr>
          </table>
        ...
        <tr>
          ...
          <td><textarea id="ta" name="ta" style="width:99%; border-style: solid; border-width: 1" rows="20" cols="50"></textarea>
      ...
      <input type="hidden" name="MM_insert" value="frmColour">
    </form>
    </td>
  </tr>
  <tr>
