...
<h1 class="style3"><font face=verdana><img src="images/alterar.png" width="48" height="48"> Cadastrar C&oacute;digos Macroscopia:</font></h1>
...

{
 ...
 $busca_cod="select * from codigo_mac where codigo = '".$codigo."';";
...

 {
  ...
  $cad_cod="insert into codigo_mac values ('','".$codigo."','".$descricao."');";
...

  {
   ...
   $busca_cod2="select * from codigo_mac where codigo = '".$codigo."';";
