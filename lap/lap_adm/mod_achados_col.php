...
if($num_conv==0)
{
 printf("<option value=''>Nenhum Achado Colposcópico encontrado");
}
...
if ($_POST['todos']) 
{
...

 {
  ...
  echo "<tr><th bordercolor=white>Achado Colposcópico</th></tr>";
...

 {
  ...
  echo "Não foi encontrado nenhum Achado Colposcópico com o nome <b>$nome</b>.";
