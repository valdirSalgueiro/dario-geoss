                ...
                <td height="464" valign="top"><table width="468" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="20" background="imgalessandro6.jpg"><table width="468" border="0" align="left" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="20" background="images/bg.jpg"><span class="style26 style28"><span class="menu"><?php if(($_SESSION['lang']=='Brazil')or($_SESSION['lang']=='')){	?></span><span class="style81">Sugest&otilde;es
...
?>
                            <table width="94%" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="587" bgcolor="#CCCCCC" style="border:2px #EAEAEA dotted;"><img src="images/ico_meus_documentos.gif" width="36" height="36" align="left" /> <span class="titulo"> Sugest&otilde;es   [ <?php print $totalcom; ?> ] </span><span class="materia"></span><br />
                                    <br />
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="21%" class="por">&nbsp;</td>
                                        <td width="79%" align="right"><a href="javascript:env_perg('<?php=$materias['codigo_noticia'] ?>')" class="l_menu_materia"> Enviar Sugest&atilde;o </a></td>
                                      </tr>
                                  </table></td>
                              </tr>
                              <tr>
